<tr>
    <td align="center" style="padding:32px;background:#16102a;color:#e8dff5;font-family:Arial,sans-serif;">
        <h1 style="margin:0 0 16px;color:#fff;font-size:24px;">{{ __tr('Verify your new email') }}</h1>

        <p style="margin:0 0 24px;font-size:15px;line-height:1.6;">
            {{ __tr('Click the button to confirm your new email address.') }}
        </p>
