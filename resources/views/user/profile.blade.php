...
<div class="lw-contains-profile-fields">
	...
	<div class="card lw-profile-image-card-container mb-3">
		<div class="card-body">
			@if($isOwnProfile)
			...
			<div class="row" id="lwProfileAndCoverEditBlock" style="display: none;">
				<div class="col-lg-3">
					<input type="file" name="filepond" class="filepond lw-file-uploader" id="lwFileUploader" data-remove-media="false"data-instant-upload="true" data-action="<?= route('user.upload_profile_image') ?>" data-label-idle="<?= __tr("Drag & Drop your picture or __browseAction__", [
...
<script>
	...
	$("#lwCloseSendGiftDialog").on('click', function(e) {
		...
		//form reset after success
		$("#lwSendGiftForm").trigger("reset");
		 // Remove active state from gift buttons
    $('.lw-group-radio-option-img').removeClass('active');
		//close dialog after success
		$('#lwSendGiftDialog').modal('hide');
	});
