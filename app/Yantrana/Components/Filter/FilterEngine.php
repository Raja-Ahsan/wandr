...
class FilterEngine extends BaseEngine implements FilterEngineInterface
{
    ...
    public function prepareApiBasicFilterData($inputData, $paginateCount = false)
    {
        ...
        if ((! getStoreSettings('include_exclude_admin')) and (! isAdmin())) {
         ...
         //array merge of unique users ids
      $ignoreUserIds = array_values(array_unique(array_merge($toUserIds,$blockUserIds,$blockMeUserIds,$mutualLikeIds,$adminIds,[getUserID()])));
